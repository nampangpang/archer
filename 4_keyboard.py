...
#화면 타이틀 설정
pygame.display.set_caption("nado coding") #게임이름

#배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\user\\Desktop\\python\\pygame_basic\\background3.png")
